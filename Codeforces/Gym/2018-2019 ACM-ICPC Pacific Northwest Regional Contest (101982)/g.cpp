...
int main(){
    ...
    PT p(x, y), p1(x1, y1), p2(x1, y2), p3(x2, y2), p4(x2, y1);

    best = min(best, distancePointSegment(p1, p2, p));
    best = min(best, distancePointSegment(p2, p3, p));
    best = min(best, distancePointSegment(p3, p4, p));
    best = min(best, distancePointSegment(p4, p1, p));
